...
app.get("/",function(req,res){
    res.render("home", {startingContent: homeStartingContent, content:posts});
})
...
app.get("/posts/:Anotherpost",function(req,res){
  const titlename = _.toLowerCase(req.params.Anotherpost);
  posts.forEach(function (element) {
      const storetitle = _.toLowerCase(element.title);
   
  if( storetitle ==titlename){
